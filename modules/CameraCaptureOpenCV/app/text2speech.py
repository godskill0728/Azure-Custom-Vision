...
class TextToSpeech():
    def __init__(self, azureSpeechServiceKey, voice='en-US-Guy24kRUS', azureTranslatorServiceKey=None, translateToLanguage=None, enableMemCache=False, enableDiskCache=False):
